...
export const getRequirementSections = () => DEFAULT_REQUIREMENT_SECTIONS

export const getLegacySnapshotSections = (reqType?: string) => (
  isUiRequirementType(reqType)
    ? UI_REQUIREMENT_SECTIONS
    : DEFAULT_REQUIREMENT_SECTIONS.filter(section => section.key !== 'dialogMap')
)
