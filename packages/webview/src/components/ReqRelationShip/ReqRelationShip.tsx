...
import { Spin, message, Button, TreeSelect, Segmented } from 'antd'
...
import type { DependencyResponse, RenderMode } from './types'
...
const ReqRelationShip: React.FC<ReqRelationShipProps> = ({ requirements, onBack }) => {
  ...
  const echartsOption = useMemo(
    () => buildEchartsOption(normalizedRelationships, requirementMap),
