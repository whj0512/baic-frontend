...
export const SECTION_CONFIG: Record<SectionKey, DimensionSectionConfig> = {
  ...
  dialogMap: { dimensionCode: 'UI', label: '会话图' },
}

export const SECTION_TO_DIMENSION_CODE: Record<SectionKey, RequirementDimensionCode> = {
  environment: 'IBD',
  interaction: 'ESD',
...
export const DIMENSION_CODE_TO_SECTION: Record<RequirementDimensionCode, SectionKey> = {
  IBD: 'environment',
  ESD: 'interaction',
