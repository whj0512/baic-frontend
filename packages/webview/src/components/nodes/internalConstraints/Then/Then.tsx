...
const Then: FC<ThenNodeProps> = (props) => {
    ...
    // 格式化显示名称
    const displayName = nodeName || 'Then';
    ...
    return (
        <div
            ...
            style={{
                ...
                color: fontColor,
                fontSize,
                ['--then-stroke' as any]: stroke,
                ['--then-fill' as any]: fill,
            }}
        >
            {/* Stencil 面板模式 */}
            {isStencil && (
                <div className="then-node__stencil">
                    <div className="then-node__stencil-inner">
                        <span className="then-node__stencil-text">S</span>
                    </div>
                </div>
            )}
            ...
            {!isStencil && (
                <>
                    <div className="then-node__shape">
                        <div className="then-node__shape-inner"></div>
                    </div>
                    <div className="then-node__content">
