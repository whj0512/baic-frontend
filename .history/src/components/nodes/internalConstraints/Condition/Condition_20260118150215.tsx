...
const Condition: FC<ConditionNodeProps> = (props) => {
    const {
        node,
        width: propWidth,
        height: propHeight,
    ...
    return (
        ...
        >
            ...
            <>
                <span className="condition-node__branch-label condition-node__branch-label--yes">
                    Y
                </span>
                <span className="condition-node__branch-label condition-node__branch-label--no">
                    N
                </span>
            </>
        </div>
