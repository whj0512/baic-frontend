...
import './ModuleResponsesGraph.css'
...
const PALETTE = [
  ...
  { type: 'event', label: '触发事件', shape: 'polygon', color: '#ffccc7' },
]
...
const ModuleResponsesGraph = ({ data, onChange, readOnly = false }: SectionGraphProps) => {
...
export default ModuleResponsesGraph
